...
$Template->assign("pagename", Tools\languageLoader::Get("str_mySnippets"));
...
$Template->assign("snippetList",$Snippets->ListMySnippet());




$Template->assign("view_headline","Snippets nach Sprache");
