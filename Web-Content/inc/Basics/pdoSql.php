...
class db
{
     ...
     * @param $bind (optional)
     *            values & parameters key/value array
     * @return mixed
     */
...
error_reporting(0);
     ...
     *            the columns requested, separated by commas
     * @param $where (optional)
     *            column = value as a string
     * @param $order (optional)
     *            column DIRECTION as a string
     * @param $bind (optional)
     *            values & parameters key/value array
     * @return mixed
     */
     ...
     * @param $fields (optional)
     *            if values don't match the number of fields
     * @param $bind (optional)
     *            values & parameters key/value array
     * @return mixed
     */
     ...
     *            the rows/values in a key/value array
     * @param $where (required)
     *            the row/condition in an array (row,condition)
     * @param $bind (optional)
     *            values & parameters key/value array
     * @return mixed
     */
